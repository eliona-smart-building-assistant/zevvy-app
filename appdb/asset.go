...
var AssetWhere = struct {
	...
	ID:              whereHelperint64{field: "\"zevvy\".\"asset\".\"id\""},
	ConfigurationID: whereHelperint64{field: "\"zevvy\".\"asset\".\"configuration_id\""},
	ProjectID:       whereHelperstring{field: "\"zevvy\".\"asset\".\"project_id\""},
	GlobalAssetID:   whereHelperstring{field: "\"zevvy\".\"asset\".\"global_asset_id\""},
	ProviderID:      whereHelperstring{field: "\"zevvy\".\"asset\".\"provider_id\""},
	AssetID:         whereHelpernull_Int32{field: "\"zevvy\".\"asset\".\"asset_id\""},
}
...
func (assetL) LoadConfiguration(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAsset interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`zevvy.configuration`),
		qm.WhereIn(`zevvy.configuration.id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func Assets(mods ...qm.QueryMod) assetQuery {
	mods = append(mods, qm.From("\"zevvy\".\"asset\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"zevvy\".\"asset\".*"})
	}
...
func FindAsset(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Asset, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"zevvy\".\"asset\" where \"id\"=$1", sel,
	)
...
func (o *Asset) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"zevvy\".\"asset\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"zevvy\".\"asset\" %sDEFAULT VALUES%s"
		}
...
func (o *Asset) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"zevvy\".\"asset\" SET %s WHERE %s",
...
func (o AssetSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"zevvy\".\"asset\" SET %s WHERE %s",
...
func (o *Asset) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"zevvy\".\"asset\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Asset) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"zevvy\".\"asset\" WHERE \"id\"=$1"
...
func (o AssetSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"zevvy\".\"asset\" WHERE " +
...
func (o *AssetSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"zevvy\".\"asset\".* FROM \"zevvy\".\"asset\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, assetPrimaryKeyColumns, len(*o))
...
func AssetExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"zevvy\".\"asset\" where \"id\"=$1 limit 1)"
