...
type Configuration struct {
	...
	VerificationURI       null.String `boil:"verification_uri" json:"verification_uri,omitempty" toml:"verification_uri" yaml:"verification_uri,omitempty"`
	VerificationURIExpire null.Time   `boil:"verification_uri_expire" json:"verification_uri_expire,omitempty" toml:"verification_uri_expire" yaml:"verification_uri_expire,omitempty"`
	VerificationInterval  null.Int32  `boil:"verification_interval" json:"verification_interval,omitempty" toml:"verification_interval" yaml:"verification_interval,omitempty"`
	AccessToken           null.String `boil:"access_token" json:"access_token,omitempty" toml:"access_token" yaml:"access_token,omitempty"`
	AccessTokenExpire     null.Time   `boil:"access_token_expire" json:"access_token_expire,omitempty" toml:"access_token_expire" yaml:"access_token_expire,omitempty"`
...
var ConfigurationColumns = struct {
	...
	VerificationURIExpire: "verification_uri_expire",
...
var ConfigurationTableColumns = struct {
	...
	VerificationURI:       "configuration.verification_uri",
	VerificationURIExpire: "configuration.verification_uri_expire",
	VerificationInterval:  "configuration.verification_interval",
	AccessToken:           "configuration.access_token",
	AccessTokenExpire:     "configuration.access_token_expire",
...
var ConfigurationWhere = struct {
	...
	VerificationURI       whereHelpernull_String
	VerificationURIExpire whereHelpernull_Time
	VerificationInterval  whereHelpernull_Int32
	AccessToken           whereHelpernull_String
	AccessTokenExpire     whereHelpernull_Time
	...
	VerificationURI:       whereHelpernull_String{field: "\"zevvy\".\"configuration\".\"verification_uri\""},
	VerificationURIExpire: whereHelpernull_Time{field: "\"zevvy\".\"configuration\".\"verification_uri_expire\""},
	VerificationInterval:  whereHelpernull_Int32{field: "\"zevvy\".\"configuration\".\"verification_interval\""},
	AccessToken:           whereHelpernull_String{field: "\"zevvy\".\"configuration\".\"access_token\""},
	AccessTokenExpire:     whereHelpernull_Time{field: "\"zevvy\".\"configuration\".\"access_token_expire\""},
	RefreshToken:          whereHelpernull_String{field: "\"zevvy\".\"configuration\".\"refresh_token\""},
	RefreshInterval:       whereHelperint32{field: "\"zevvy\".\"configuration\".\"refresh_interval\""},
	RequestTimeout:        whereHelperint32{field: "\"zevvy\".\"configuration\".\"request_timeout\""},
	Active:                whereHelpernull_Bool{field: "\"zevvy\".\"configuration\".\"active\""},
	Enable:                whereHelpernull_Bool{field: "\"zevvy\".\"configuration\".\"enable\""},
	UserID:                whereHelpernull_String{field: "\"zevvy\".\"configuration\".\"user_id\""},
	ProjectID:             whereHelpernull_String{field: "\"zevvy\".\"configuration\".\"project_id\""},
}
...
func (o *Configuration) Assets(mods ...qm.QueryMod) assetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"zevvy\".\"asset\".\"configuration_id\"=?", o.ID),
	)
...
func (configurationL) LoadAssets(ctx context.Context, e boil.ContextExecutor, singular bool, maybeConfiguration interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`zevvy.asset`),
		qm.WhereIn(`zevvy.asset.configuration_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, rel := range related {
		if insert {
			...
			updateQuery := fmt.Sprintf(
				"UPDATE \"zevvy\".\"asset\" SET %s WHERE %s",
...
func Configurations(mods ...qm.QueryMod) configurationQuery {
	mods = append(mods, qm.From("\"zevvy\".\"configuration\""))
	q := NewQuery(mods...)
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"zevvy\".\"configuration\".*"})
	}
...
func FindConfiguration(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Configuration, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"zevvy\".\"configuration\" where \"id\"=$1", sel,
	)
...
func (o *Configuration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			cache.query = fmt.Sprintf("INSERT INTO \"zevvy\".\"configuration\" (\"%s\") %%sVALUES (%s)%%s", strings.Join(wl, "\",\""), strmangle.Placeholders(dialect.UseIndexPlaceholders, len(wl), 1, 1))
		} else {
			cache.query = "INSERT INTO \"zevvy\".\"configuration\" %sDEFAULT VALUES%s"
		}
...
func (o *Configuration) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		cache.query = fmt.Sprintf("UPDATE \"zevvy\".\"configuration\" SET %s WHERE %s",
...
func (o ConfigurationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	sql := fmt.Sprintf("UPDATE \"zevvy\".\"configuration\" SET %s WHERE %s",
...
func (o *Configuration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"zevvy\".\"configuration\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
func (o *Configuration) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"zevvy\".\"configuration\" WHERE \"id\"=$1"
...
func (o ConfigurationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"zevvy\".\"configuration\" WHERE " +
...
func (o *ConfigurationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "SELECT \"zevvy\".\"configuration\".* FROM \"zevvy\".\"configuration\" WHERE " +
		strmangle.WhereClauseRepeated(string(dialect.LQ), string(dialect.RQ), 1, configurationPrimaryKeyColumns, len(*o))
...
func ConfigurationExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"zevvy\".\"configuration\" where \"id\"=$1 limit 1)"
